...
export class Marker extends Object3D {
  ...
  update() {
    this.currentTime += this.setting.waveAttr.waveSpeed / 1000;
    if (this.wavePointEntity.material.uniforms.currentTime) {
      this.wavePointEntity.material.uniforms.currentTime.value =
        this.currentTime;
    }
  }
